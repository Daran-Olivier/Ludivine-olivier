...
function createProduct($db) {
    ...
    $sql = "INSERT INTO products (name, category, description, short_description, price, image_url, benefits, ingredients, usage, stock_status, featured) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
function updateProduct($db, $id) {
    ...
    $usage = $_POST['usage'] ?? $existing['usage'];
    ...
    $sql = "UPDATE products SET 
            ...
            usage = ?, stock_status = ?, featured = ?, updated_at = NOW() 
            WHERE id = ?";
...
function deleteProduct($db, $id) {
    ...
    sendJSON(['message' => 'Produit supprimé avec succès']);
}
