...
function displayProducts(productsToDisplay) {
    if (productsToDisplay.length === 0) {
        productsGrid.innerHTML = '<p style="text-align: center; color: #6b7280; grid-column: 1/-1;">Aucun produit trouvé</p>';
        return;
    }
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                <div class="product-header">
                    ...
                    ${product.is_featured ? '<i class="fas fa-star product-featured" title="En vedette"></i>' : ''}
                </div>
...
async function confirmDelete() {
    ...
    try {
        const response = await fetch(`${API_URL}/products.php?id=${productToDelete}`, {
            method: 'DELETE'
        });
