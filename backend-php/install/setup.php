    ...
    if ($result['count'] == 0) {
        ...
        $products = [
            [
                ...
                'usage_instructions' => 'Prendre 2 gélules par jour le matin',
            ...
            [
                ...
                'usage_instructions' => 'Prendre 1 gélule 30 minutes avant le coucher',
                'stock_status' => 'in_stock',
                'featured' => 1
            ],
            [
                ...
                'usage_instructions' => 'Diluer 1 dose dans un verre d\'eau chaque matin',
                'stock_status' => 'in_stock',
                'featured' => 0
            ],
            [
                ...
                'usage_instructions' => 'Préparer comme un café traditionnel',
                'stock_status' => 'in_stock',
                'featured' => 0
            ]
        ];
        ...
        $stmt = $db->prepare(
            "INSERT INTO products (name, category, short_description, description, price, benefits, ingredients, usage_instructions, stock_status, featured)
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
        );
